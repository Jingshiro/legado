...
- **AI 助手**：引入大模型交互能力，可以跟AI聊聊剧情了。支持工具调用（Function Calling），AI可查询和管理书架、书源、订阅等数据（写操作需用户确认）。支持从"我的"页面独立进入。
- **主题全量导出功能**：支持直接分享全部主题设置。
- **阅读小票**：烂书不退款，好书请多读:) 支持在其他设置中开关显示。
- **Webdav备份管理增强**：允许本地对云端备份进行删除、重命名等操作
- **导出想法到 Obsidian**：支持将书中的想法/笔记一键导出至 Obsidian（支持 REST API 或本地文件模式）。
- **读完/刷书标签优化**：在其他设置中新增弹窗提示开关与标签显示开关，支持独立控制弹窗触发和书架标签展示。

## cronet版本: 128.0.6613.40

**2026/05/08**

- AI 助手新增工具调用功能（Phase 1 + Phase 2）：
