...
- 新增：详细阅读记录功能（支持查看、导出与统计）
- 新增：在线查询订阅源导入（订阅：https://pub-0e6ce5d0161d4148a621c594405613f1.r2.dev/rssSource_阅读记录查询.json）
- 新增：想法功能（支持长按文字写想法、分享想法到卡片）
- 优化：同步代码时的历史记录清理与 .gitignore 配置更新
